...
type Amount struct {
	...
	Amount   int64  `protobuf:"varint,1,opt,name=amount,proto3" json:"amount,omitempty"`    // position 1
	Currency string `protobuf:"bytes,2,opt,name=currency,proto3" json:"currency,omitempty"` // position 2
}
...
var file_invoicer_proto_rawDesc = []byte{
	...
	0x6d, 0x2f, 0x72, 0x6f, 0x79, 0x73, 0x79, 0x62, 0x6f, 0x79, 0x2f, 0x64, 0x65, 0x6d, 0x6f, 0x2d,
